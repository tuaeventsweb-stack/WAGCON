...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WAGCON 2027 — West Africa Gaming Convention · Co-located with ABDS 2027 - Africa Blockchain Week" },
      {
        name: "description",
        content:
          "West Africa's premier gaming convention. Three days, two venues, Lagos. 29 April – 1 May 2027.",
      },
