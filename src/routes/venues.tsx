        ...
        <section className="relative pt-32 pb-16 overflow-hidden border-b border-white/5 bg-wagcon-bg2">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 text-center">
            ...
            <h1 className="font-heading text-4xl md:text-6xl font-black mb-6 tracking-tighter leading-[0.9]">
              Three Days. <Accent>Two Venues</Accent>.
            </h1>
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-6 space-y-6">
                <span className="text-[10px] uppercase font-bold text-primary tracking-widest block">VENUE 01 · DAYS 1 & 2</span>
                <SectionTitle>The Arena — Lagos Oriental Hotel</SectionTitle>
                
                <div className="flex flex-wrap gap-4 text-xs font-body uppercase text-white/50 tracking-wider">
                  <span className="flex items-center gap-1"><Calendar size={13} className="text-primary" /> 28–29 April 2027</span>
                ...
                <p className="text-sm md:text-base text-white/70 font-body leading-relaxed">
                  Lagos Oriental Hotel serves as the core hub for WAGCON 2027 and our co-located event, **ABDS 2027 - Africa Blockchain Week**. The Arena hosts all B2B conference keynotes, panel sessions, the indie developer showcase, standard exhibition booths, B2B meeting lounges, and our live esports tournament arena.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center border-t border-white/5 pt-16">
              <div className="lg:col-span-6 lg:order-2 space-y-6">
                <span className="text-[10px] uppercase font-bold text-primary tracking-widest block">VENUE 02 · DAY 3</span>
                <SectionTitle>The After Party — Fahrenheit</SectionTitle>
                
                <div className="flex flex-wrap gap-4 text-xs font-body uppercase text-white/50 tracking-wider">
                  <span className="flex items-center gap-1"><Calendar size={13} className="text-primary" /> 30 April 2027</span>
