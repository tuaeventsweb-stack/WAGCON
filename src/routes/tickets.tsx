...
export const Route = createFileRoute("/tickets")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Redirecting to the official WAGCON 2027 ticketing page on Eventpadi." },
      { property: "og:title", content: "Tickets & Passes — WAGCON 2027" },
      { property: "og:description", content: "Redirecting to the official WAGCON 2027 ticketing page on Eventpadi." },
